...
const styles = `
  ...
  .tv-panel.tv-hot-artwork { grid-column:span 7; }
  .tv-panel.tv-artwork-orders { grid-column:span 5; }
  ...
  @media(max-width:1400px){ .tv-kpis{grid-template-columns:repeat(4,1fr)} .tv-grid{grid-template-columns:1fr 1fr} .tv-panel,.tv-panel.tv-hot-artwork,.tv-panel.tv-artwork-orders,.tv-panel.tv-production,.tv-panel.tv-field{grid-column:span 1} }
